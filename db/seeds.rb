...
fifth_car = Car.create(model: 'Nissan GT-R', year: '2015', price: 2550, image: 'https://i0.wp.com/www.thesupercarblog.com/wp-content/uploads/2023/04/2024-nissan-gt-r-nismo-special-edition.jpg?resize=1000%2C600&ssl=1')
sixth_car = Car.create(model: 'Ford GT', year: '2016', price: 1550, image: 'https://media.gettyimages.com/id/1406533077/photo/the-ford-gt.jpg?s=612x612&w=gi&k=20&c=QT009xEgUUa3CgCqS5PSisBGOqtjS_ND1lpMoBGPBFI=')
...
first_res = Reservation.create(start_date: '24-03-2023', end_date: '25-03-2023', city: 'London', user_id: 4, car_id: 2)
second_res = Reservation.create(start_date: '29-03-2023', end_date: '30-03-2023', city: 'Lisbon', user_id: 1, car_id: 1)
